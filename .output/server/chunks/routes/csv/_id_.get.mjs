import { d as defineEventHandler, f as getRouterParam, h as createError, g as getDb, i as setResponseHeader } from '../../nitro/nitro.mjs';
      ...
      for (const j in category.categoryItems) {
        ...
        if (categoryItem) {
          ...
          const itemRow = [
            ...
            (_a = fullUnits[item.authorUnit]) != null ? _a : item.authorUnit,
            item.url,
            `${item.price}`,
