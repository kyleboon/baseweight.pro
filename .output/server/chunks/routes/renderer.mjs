...
import { j as joinRelativeURL, k as useRuntimeConfig, l as getResponseStatusText, m as getResponseStatus, n as defineRenderHandler, e as getQuery, h as createError, o as destr, p as getRouteRules, q as joinURL, t as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"LighterPack"};

const appRootTag = "div";

const appRootAttrs = {"id":"lp"};
