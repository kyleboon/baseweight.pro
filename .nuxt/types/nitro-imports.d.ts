declare global {
  ...
  const isModerator: typeof import('../../server/utils/auth').isModerator
  ...
  const upsertUser: typeof import('../../server/utils/db').upsertUser
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/kyleboon/code/lighterpack/.worktrees/phase-5-nuxt-migration/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/kyleboon/code/lighterpack/.worktrees/phase-5-nuxt-migration/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { verifyPassword, isModerator } from '/Users/kyleboon/code/lighterpack/.worktrees/phase-5-nuxt-migration/server/utils/auth';
export { getDb, upsertUser } from '/Users/kyleboon/code/lighterpack/.worktrees/phase-5-nuxt-migration/server/utils/db';